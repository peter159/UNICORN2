;;; smart-semicolon-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
`Smart-Semicolon mode' mode.  If the prefix argument is positive,
...
(provide 'smart-semicolon-autoloads)
